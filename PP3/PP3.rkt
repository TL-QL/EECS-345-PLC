...
(define interpret-statement-list
  (lambda (statement-list environment return break continue throw)
    (if (null? statement-list)
        ...
        (interpret-statement-list (rest-of-statement statement-list) (interpret-statement (current-statement statement-list) environment return break continue throw) return break continue throw))))
...
(define interpret-funcall
  (lambda (statement environment throw)
    (call/cc
     (lambda (func-return)
      (interpret-funcall-body (function-body (lookup (func-name statement) environment))
